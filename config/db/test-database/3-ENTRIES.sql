...
insert into user (name,password) values ('admin','$2a$10$aDj7m/oe.5ctksTSJO6QXeYYt1ZWchRyxmjIEsxRibfEljN3HP3E.');
insert into user (name,password) values ('user','$2a$10$WmSu6xeosGt/ls9XoGuwV.1HkKT0XezjaYKn3D0ELIuoQSF8UGAie');

insert into role (id,username,role) values ( 1, 'admin', 'ROLE_ADMIN');
insert into role (id,username,role) values ( 2, 'admin', 'ROLE_USER');
insert into role (id,username,role) values ( 3, 'user', 'ROLE_USER');
